module.exports = {
  ...
  rules: {
    ...
    'default-param-last': 'off', // params default값 뒤로 (redux reducer에서 state, action위치)
    '@typescript-eslint/default-param-last': ['off'], // params default값 뒤로 (redux reducer에서 state, action위치)
  },
};
